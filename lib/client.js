...
function goalDuration(milliseconds) {
...
function TimedGoalDock({ useProjection, useGoalActivation, t, ...actions }) {
...
const inject = ['slots', 'sessions', 'remote', 'remote.goals', 'settingsScope', 'conversation', 'locale', 'modelDirectories']
