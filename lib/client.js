window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const imageFromBlock = (block) => !('kind' in block) ? null : block.content.find((part) => part.type === 'image')?.attachment ?? null
    ...
    function apply(ctx) {
      ...
      ctx.slots.inject('tool.call.toolview', () => ctx.slots.register({ name: 'tool.call.toolview', key: 'read_image', locale: 'conversation' }, (props) => React.createElement(ReadImageView, { ...props, sessions })))
    }
