        ...
        const sync = () => {
          ...
          for (const flow of document.querySelectorAll('[data-chat-flow]')) {
            ...
            const flush = () => {
              ...
              Object.assign(group.button.style, toolGroupButtonStyle); group.button.setAttribute('aria-expanded', String(expanded)); group.button.textContent = `${expanded ? '⌄' : '›'} 执行过程 · ${run.length} 项`
