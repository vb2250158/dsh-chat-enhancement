window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const ToolCallActivityGroupController = createActivityGroupController({ toggleKey: 'dshChatEnhancementToolGroupToggle', parentNodes: () => document.querySelectorAll('[data-chat-flow]'), isActivity: (row) => isGroupedActivity(row.dataset.chatFlowKind), groupKey: toolGroupKey, label: (count) => `已执行 ${count} 项操作` })
