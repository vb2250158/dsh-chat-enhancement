window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const ThinkingActivityGroupController = createActivityGroupController({ toggleKey: 'dshChatEnhancementThinkingGroupToggle', parentNodes: () => [document.body], rowsForParent: () => [...document.querySelectorAll('[data-variant="think"]')], isActivity: (row) => row.dataset.variant === 'think', groupKey: reasoningGroupKey, label: (count) => `已完成 ${count} 项思考` })
